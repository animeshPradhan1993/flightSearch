...
public class ExceptionIntercepter {
	...
	public ResponseEntity<?> handleAllExceptions(Exception ex) {
		...
		if (ex instanceof BadRequestException) {
			...
			return createResourceNotFoundException(new FlightNotFoundException(ex.getMessage()));
		} else {
	...
	public ResponseEntity<ErrorResponse> createResourceNotFoundException(FlightNotFoundException ex) {
